...
func SetupDatabase() {
	database, err := gorm.Open(sqlite.Open("test-my-self-react.db"), &gorm.Config{})
	if err != nil {
	...
	//
	// จำลองตาราง EquipmentPurchasing ------
